...
DEFINE('_JX_POSTINGNOTALLOWED', 'Sie haben keine Berechtigung um in das G&auml;stebuch zu schreiben.');
DEFINE('_JX_NOTOWNER', 'Sie sind nicht der Eigent&uuml;mer dieses Eintrages' );
DEFINE('_JX_NOTLOGGEDIN', 'Sie m&uuml;ssen eingeloggt sein um Eintr&auml;ge bearbeiten zu k&ouml;nnen.');
...
Um den Eintrag zu best&auml;tigen, gehen Sie zu:
...
<<ENTRY>>
');
DEFINE('_JX_YOUPOSTEDITEM', 'Danke f&uuml;r Ihren Eintrag im G&auml;stebuch');
...
DEFINE('_JX_ITEMSENT', 'Danke f&uuml;r Ihren Eintrag in unserem G&auml;stebuch. Wir werden uns den Eintrag in K&uuml;rze ansehen.');
DEFINE('_JX_ITEMDELETED', 'G&auml;stebucheintrag wurde gel&ouml;scht.');
DEFINE('_JX_NO_RESULTS', 'Keine Ergebnisse.');
DEFINE('_JX_NOTHING_FOUND', 'Keine passenden Ergebnisse zu Ihrer Suchanfrage.');
DEFINE('_JX_ACCESS_DENIED', 'Keine Berechtigung. Bitte loggen Sie sich ein oder registrieren sich.');
...
DEFINE('_JX_A_AREYOUSURE', 'Sind Sie sicher ?');
...
DEFINE('_JX_A_NOTITLE', 'Bitte einen Titel eingeben');
...
DEFINE('_JX_A_NOCONTENT', 'Bitte geben Sie einen Text ein.');//ALERT
...
DEFINE('_JX_A_IMPORT_FINISHED_DESCR', 'Sie haben folgende <<NUMBER>> Eintr&auml;ge importiert');
...
DEFINE('_JX_A_DONATION_DESC', 'Um die weitere Entwicklung an dieser freien Komponente zu unterst&uuml;tzen, bitte &uuml;berlegen Sie dem Autor &uuml;ber die Schaltfl&auml;che weiter unten etwas zu spenden.');
...
DEFINE('_JX_A_ALLOWEDHTML', 'Wenn bei \'HTML im Beitrag entfernen\' ausgew&auml;lt wurde \'Nicht erlaubte HTML Tags entfernen\', dann werden nur diese Tags im Beitrag beibehalten. (Trennen Sie die einzelnen Tags mit Komma)');
...
// Error messages
DEFINE('_JX_ERR_YOURCONFIG', 'Ihre Konfigurationsdatei ist');
DEFINE('_JX_ERR_CHMODFILE', 'Sie m&uuml;ssen die Rechte auf 766 setzen, um die Einstellungen zu speichern.');
