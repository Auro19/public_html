...
//	Configuration
//
//deactivated by JoomGallery team, image now in CSS
//var fileLoadingImage = "components/com_joomgallery/assets/js/lightbox/images/loading.gif";
//var fileBottomNavCloseImage = "components/com_joomgallery/assets/js/lightbox/images/close.gif";
...
Lightbox.prototype = {
	...
	updateDetails: function() {
		...
		if(imageArray.length > 1){
			...
			Element.setInnerHTML( 'numberDisplay', joomgallery_image+" " + eval(activeImage + 1) + " "+joomgallery_of+" " + imageArray.length);
		}
