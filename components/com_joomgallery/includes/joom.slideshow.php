<?php
// $HeadURL: http://joomlacode.org/svn/joomgallery/JG-1.0/JG/trunk/components/com_joomgallery/includes/joom.slideshow.php $
// $Id: joom.slideshow.php 396 2009-03-15 16:06:21Z aha $
/******************************************************************************\
**   JoomGallery  1.0.1                                                       **
...
function joom_createphotoobject() {
  ...
  /*
  this.color_normal = "< ?php echo $ag_minibordercolor; ?>";
  this.color_active = "< ?php echo $ag_miniabordercolor; ?>";
  */
  this.minis        = <?php echo $jg_minis; ?>;

  this.time         = <?php echo $jg_slideshow_timer; ?>*1000;
  this.usefilter    = <?php echo $jg_slideshow_usefilter; ?>;
  this.filterchance = <?php echo $jg_slideshow_filterbychance; ?>;
  this.filtertimer  = <?php echo $jg_slideshow_filtertimer; ?>;
  this.resize       = <?php echo $jg_resizetomaxwidth; ?>;
  this.maxwidth     = <?php echo $jg_maxwidth; ?>;

  //Get language
  this.pause_data = "<img src=\"<?php echo $mosConfig_live_site . "/components/com_joomgallery/assets/images/control_pause.png";?>\" border=\"0\" width=\"16\" height=\"16\" alt=\"<?php echo _JGS_PAUSE; ?>\" class=\"pngfile jg_icon\" />";
  this.goon_data  = "<img src=\"<?php echo $mosConfig_live_site . "/components/com_joomgallery/assets/images/control_play.png";?>\" border=\"0\" width=\"16\" height=\"16\" alt=\"<?php echo _JGS_GO_ON; ?>\" class=\"pngfile jg_icon\" />";
  this.repeat     = "<?php echo _JGS_ALERT_ONCE_AGAIN; ?>";
...
<?php
  if($jg_showdetail!=0) {
?>
    this.tochange[0] = new Array(<?php echo ( $jg_showdetail )            ? "1" : "0"; ?>,'jg_photo_title');
    this.tochange[1] = new Array(<?php echo ( $jg_showdetaildescription ) ? "1" : "0"; ?>,'jg_photo_description');
    this.tochange[2] = new Array(<?php echo ( $jg_showdetaildatum )       ? "1" : "0"; ?>,'jg_photo_date');
    this.tochange[3] = new Array(<?php echo ( $jg_showdetailhits )        ? "1" : "0"; ?>,'jg_photo_hits');
    this.tochange[4] = new Array(<?php echo ( $jg_showdetailrating )      ? "1" : "0"; ?>,'jg_photo_rating');
    this.tochange[5] = new Array(<?php echo ( $jg_showdetailfilesize )    ? "1" : "0"; ?>,'jg_photo_filesize');
    this.tochange[6] = new Array(<?php echo ( $jg_showdetailauthor )      ? "1" : "0"; ?>,'jg_photo_author');
<?php
  }
?>
  ...
  if(this.loadstatus()) {
    ...
    if(this.repeatonce) {
      ...
      if(browserName=="Microsoft Internet Explorer" &&
        this.filter!=0 && this.usefilter != 0) {
...
for($i=0;$i<sizeof($fileinfo['id']);$i++) {
  ...
  $jg_slideshow_data .= $jg_between;
  if ( $fileinfo['date'][$i] != '' ) {
    $jg_slideshow_data .= strftime("$jg_dateformat",$fileinfo['date'][$i]);
  } else {
    $jg_slideshow_data .= "";
  }
  ...
  if ( $fileinfo['rating1'][$i] > 0 ) {
    $jg_slideshow_data .= number_format( $fileinfo['rating2'][$i] / $fileinfo['rating1'][$i], 2, ",", "." )."(".$fileinfo['rating1'][$i]._JGS_VOTES.")";
  } else {
    $jg_slideshow_data .= _JGS_NO_VOTES;
  }
  $jg_slideshow_data .= $jg_between;
