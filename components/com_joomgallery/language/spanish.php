<?php
// $HeadURL: https://joomgallery.org/svn/joomgallery/JG-1.0/LF/trunk/UTF-8/language/spanish.php $
...
DEFINE('_JGS_CATEGORY','categoría');
...
DEFINE('_JGS_NEW_CATEGORY_MAXCOUNT','N&uacute;mero m&aacute;ximo de categorías que puede crear: ');
DEFINE('_JGS_NEW_CATEGORY_YOURCOUNT','N&uacute;mero de categorías creadas: ');
DEFINE('_JGS_NEW_CATEGORY_REMAINDER','N&uacute;mero de categorías que puede crear: ');
DEFINE('_JGS_NEW_CATEGORY','categoría nueva');
DEFINE('_JGS_PICTURES','im&aacute;genes');
DEFINE('_JGS_PARENT_CATEGORY','categoría superior');
DEFINE('_JGS_ACCESS','Accesos');
DEFINE('_JGS_PUBLISHED','Publicada');
DEFINE('_JGS_EDIT','Editar');
DEFINE('_JGS_YOU_NOT_HAVE_CATEGORY','No tiene usted ninguna categoría.');
DEFINE('_JGS_ALERT_CATEGORY_MUST_HAVE_TITLE','La categoría tiene que tener un título');//ALERT
DEFINE('_JGS_MODIFY_CATEGORY','Editar categoría');
...
DEFINE('_JGS_SUBCATEGORIES','Subcategorías');
DEFINE('_JGS_SPECIAL_MEMBERS','[SM]');
DEFINE('_JGS_REGISTERED_MEMBERS','[RM]');
DEFINE('_JGS_THERE_IS','Es la');
DEFINE('_JGS_PICTURE_IN_CATEGORY','imagen de esta categoría.');
DEFINE('_JGS_THERE_ARE','Son las');
DEFINE('_JGS_PICTURES_IN_CATEGORY','im&aacute;genes de esta categoría.');
...
DEFINE('_JGS_SUBCATEGORY_IN_CATEGORY','Subcategoría de esta categoría');
DEFINE('_JGS_SUBCATEGORIES_IN_CATEGORY','Subcategorías de esta categoría');
...
DEFINE('_JGS_CATEGORIES','categorías');
...
DEFINE('_JGS_USER_ORDERBY_CATNAME_ASC','Ascendente por categoría');
DEFINE('_JGS_USER_ORDERBY_CATNAME_DESC','Descendente por categoría');
...
DEFINE('_JGS_ERROR_DELETING_CATEGORY_DIRECTORY','¡Ocurri&oacute; un error al intentar borrar la carpeta de categorías!');
DEFINE('_JGS_ERROR_DELETING_CATEGORY_DATABASE_ENTRY','Ocurri&oacute; un error al intentar borrar la categoría en la base de datos!'); 
DEFINE('_JGS_SUCCESS_DELETING_CATEGORY','categoría borrada correctamente.'); 
...
DEFINE('_JGS_SEARCH','Buscando galería...');
DEFINE('_JGS_NUMB_PICTURES_ALL','N&uacute;mero total de im&aacute;genes en todas las categorías: ');
...
DEFINE('_JGS_MOST_VIEWED','M&aacute;s Visitadas');
DEFINE('_JGS_CATEGORY_IN_GALLERY','categoría de esta galer&iacute;a.');
DEFINE('_JGS_CATEGORIES_IN_GALLERY','categorías de esta galer&iacute;a.');
DEFINE('_JGS_BACK_TO_CATEGORY','Volver a la vista de categoría');
