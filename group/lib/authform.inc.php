...
<br /><br />
<div title="PHProjekt Login" style="background-color:#C12026;height:41px;width:100%;">
';
if (strlen($logo_src)) {
...
var browserName=navigator.appName; 
 ...
 {
  document.write('<meta http-equiv="Refresh" content="0; URL=newIndex.html" />');
 }
</SCRIPT>
<br />
...
<div style="text-align:center;">
    ...
    <form action="<?php echo PATH_PRE; ?>index.php" method="post" name="frm">
        ...
        <fieldset style="background-color:#C12026;width: 35em;height: 10em;padding:0em;margin:auto;">
            <legend><!-- <b><?php echo __('Log in, please'); ?></b>--!></legend>
            <label for="loginstring" style="clear:both;float: left;text-align: right;width: 6.3em;margin: 0.4em;"> <b><?php echo __('Login'); ?></b></label>
            ...
            <label for="user_pw" style="clear:both;float: left;text-align: right;width: 6.3em;margin: 0.4em;"><b><?php echo __('Password'); ?></b></label>
            ...
            <span style=" font-size:1em;float: left;text-align: left;margin: 0.2em;margin-left: 6.9em;"><input  type="checkbox" tabindex="2" name="remember_me" id="remember_me" title="<?php echo __('Remember me on this computer.'); ?>" /><b><?php echo " ".__('Remember me on this computer'); ?></b></span><br style="clear:both"/>
