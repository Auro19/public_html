...
$oExportPdf = new a_areas_grid_export_pdf;
$oExportPdf->exportPdf();

class a_areas_grid_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - t_area :: PDF</title>
 ...
 function checkPDF() {
  $.get(nm_url_rand("a_areas_grid_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['a_areas_grid']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['a_areas_grid']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_a_areas_grid.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['a_areas_grid']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['a_areas_grid']['pdf_name'] : "a_areas_grid.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="a_areas_grid.php" target="<?php echo $NM_target; ?>" style="display: none"> 
