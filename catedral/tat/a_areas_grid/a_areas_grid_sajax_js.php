  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_a_areas_grid" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function a_areas_grid_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_id_cond = scAjaxGetFieldSelect("id_cond");
    var var_id = scAjaxGetFieldText("id");
    var var_nombre_cond = scAjaxGetFieldSelect("nombre_cond");
    ...
    x_a_areas_grid_ajax_save_filter( var_id_cond, var_id, var_nombre_cond, var_nombre, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, a_areas_grid_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function a_areas_grid_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function a_areas_grid_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_a_areas_grid_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, a_areas_grid_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function a_areas_grid_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function a_areas_grid_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_a_areas_grid_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, a_areas_grid_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function a_areas_grid_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  var ajax_error_list = {
    ...
    "nombre": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
