...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["TelecomAdmin_____a_areas_grid"]))
   {
      unset($_SESSION['session_sec_aplicacao']["TelecomAdmin_____a_areas_grid"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['a_areas_grid']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['a_areas_grid']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['a_areas_grid']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['a_areas_grid']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['a_areas_grid']['sc_modal']);
