...
class a_areas_grid_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      if (isset($this->NM_ajax_info['param']['nombre_cond']))
      {
          $nombre_cond = $this->NM_ajax_info['param']['nombre_cond'];
      }
      if (isset($this->NM_ajax_info['param']['nombre']))
      {
          $nombre = $this->NM_ajax_info['param']['nombre'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . a_areas_grid_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . a_areas_grid_pack_protect_string($Tipo_filter[0]) . "\">.." . a_areas_grid_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "a_areas_grid.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - t_area</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  a_areas_grid_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  a_areas_grid_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  a_areas_grid_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("a_areas_grid_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="a_areas_grid.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - t_area</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['id_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['nombre_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['NM_operador']; 
...
<?php
   if (is_file("a_areas_grid_help.txt"))
   {
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="nombre_cond">
       ...
       <OPTION value="df" <?php if ("df" == $nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_nombre" name="nombre" value="<?php echo NM_encode_input($nombre) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['a_areas_grid']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['a_areas_grid']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="a_areas_grid.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "TelecomAdmin/a_areas_grid";
             ...
             if (@is_file($this->NM_path_filter . $NM_patch . "/" . $NM_arq))
             {
                 ...
                 if (substr($NMcmp_filter[0], 0, 6) == "SC_V6_")
                 {
                     ...
                     if (!empty($Name_filter))
                     {
                         ...
                         $this->NM_fil_ant[$Name_filter][1] = "Pública";
                         $Sc_v6 = true;
                     }
                 }
                 if (!$Sc_v6)
                 {
                     ...
                     $this->NM_fil_ant[$NM_arq][1] = "Pública";
                 }
             }
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['a_areas_grid']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      ...
      { 
          ...
          $NM_temp  = (isset($nombre_cond)) ? $nombre_cond : ""; 
          $NM_str_filter .= "nombre_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($nombre)) ? $nombre : ""; 
          $NM_str_filter .= "nombre#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_patch .= "TelecomAdmin/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
          $NM_patch .= "a_areas_grid/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['a_areas_grid']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['id_cond'] = 'select';
      $tp_html['nombre_cond'] = 'select';
      $tp_html['id'] = 'text';
      $tp_html['nombre'] = 'text';
              ...
              if (isset($tp_html[$Cada_cmp[0]]))
              {
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv[] = a_areas_grid_pack_protect_string(trim($v_fim[0]));
                         if (isset($Look_man[$Cada_cmp[0]][$v_fim[0]]))
                         {
                             $v_fim[0] = $v_fim[0] . "##@@" . $Look_man[$Cada_cmp[0]][$v_fim[0]];
                         }
                         $Cada_val_sv1[] = a_areas_grid_pack_protect_string(trim($v_fim[0]));
                      }
                  ...
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(a_areas_grid_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['nombre'] = $nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $id;
      if (strtoupper($id_cond) != "II" && strtoupper($id_cond) != "QP" && strtoupper($id_cond) != "IN") 
      { 
      ...
      //----- $nombre
      if (isset($nombre) || $nombre_cond == "nu" || $nombre_cond == "nn")
      {
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['opcao']              = "pesq";
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['prim_vez']           = "N";
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['a_areas_grid']['where_pesq_ant'] = $this->comando . $this->comando_fim;
