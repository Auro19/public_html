...
{
        if(!isset($_SESSION['nm_session']['cache']['prod_v7'][$ini_file]) || empty($_SESSION['nm_session']['cache']['prod_v7'][$ini_file]))
        {
                global $nm_config;
                ...
                $_SESSION['nm_session']['cache']['prod_v7'][$ini_file] = $arr_prod_ini;
        }

    return $_SESSION['nm_session']['cache']['prod_v7'][$ini_file];
}
