...
?>
   ...
   <tr style="display:<?php echo (in_array($dbms, array('firebird', 'odbc', 'sybase')) ? "" : "none"); ?>">
   ...
   <tr style="display:<?php echo ($dbms == 'mysql' ? '' : 'none'); ?>">
      <td class="nmLineV3" width="<?php echo $td_width_1; ?>">&nbsp;&nbsp;&nbsp;<?php echo $nm_lang['label']['port']; ?>&nbsp;</td>
      <td class="nmLineV3" width="<?php echo $td_width_2; ?>">
