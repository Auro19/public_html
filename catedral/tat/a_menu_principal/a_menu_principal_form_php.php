...
session_start();
class a_menu_principal_form_php
{
      var $sc_script_name;
      var $nm_location;
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['a_menu_principal']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['a_menu_principal']['glo_nm_path_prod']))
      {
      ...
      $this->nm_location .= "a_menu_principal.php"; 
...
<?php
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['a_menu_principal'] as $id_item => $arr_item)
         {
      ...
      {
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "a_areas_grid")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . "a_areas_grid/a_areas_grid.php?nm_run_menu=1&nm_apl_menu=a_menu_principal&script_case_init=1&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="a_menu_principal"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "a_menu_principal")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'a_menu_principal', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new a_menu_principal_form_php();
$controle->init();
?>
