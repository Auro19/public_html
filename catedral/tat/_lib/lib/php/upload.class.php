...
class UploadHandler
{
    ...
    private function handle_file_upload($uploaded_file, $name, $size, $type, $error) {
        ...
        $file->type = $type;
		// scriptcase
		$sUploadFileNameOrig = $file->name;
		$sUploadFileNameProt = $sUploadFileNameOrig;
		if (isset($_SESSION['scriptcase']['charset']) && 'UTF-8' != $_SESSION['scriptcase']['charset'])
		{
			$sUploadFileNameProt = mb_convert_encoding($sUploadFileNameProt, 'UTF-8', $_SESSION['scriptcase']['charset']);
		}
        ...
        if (!$error && $file->name) {
            ...
            $file_path = $this->options['upload_dir'].$file->sc_random;
			// ----------
