...
<tr>
  <td>
    ...
    <form action="<?=$_SERVER['../../php_validation/PHP_SELF']?>" method="post">

    <p class="title">PHP Validation Demo</p>

    <p>
      This form contains all the validation options that are offered by the
      <a href="../../php_validation/index.php">PHP Validation library</a>. To see how this works, <a href="../../php_validation/php_validation.zip">download
