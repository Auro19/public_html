...
function com_install()
{
    ...
    $fileOrigins = JPATH_ADMINISTRATOR.DS."components".DS."com_noixacl".DS."libraries".DS."installer".DS."adapters".DS."adapter.php";
    ...
    if( !JFile::move($fileOrigins,$fileDestiny) ){
        echo JText::_("ERRORCOPYLIB");
    }
}