<?php 
/**
* @version 1.1.0 $id constants.php
...
//URLs Media player
$url = 	JURI::base().'plugins/content/mediaplayer/';
define( '_URL_', $url );
...
define( '_PlayerDIV_1_', '<div id="plg_mediaplayer');
define( '_PlayerDIV_2_', '">' . $link . ' ' . JText::_('TO_SEE_THIS_PLAYER'). ' </div>' );
//Constant Var
define( '_FILE_'	, $file );
//Design
