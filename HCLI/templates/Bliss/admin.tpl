  ...
  <div id="page">
    ...
    <div id="content">
      ...
      <table cellpadding="0" cellspacing="0" id="footer">
        <tr>
          <td id="footer_left">
            {$lang.powered_by} <a href="http://www.helpcenterlive.com" target="_blank">Help Center Live</a> {$conf.version}<br />Copyright &copy; <a href="http://www.helpcenterlive.com">Help Center Live</a>. All Rights Reserved.
          </td>
          <td id="footer_right">
