...
<div id="footer">
  {$lang.powered_by} <a href="http://www.helpcenterlive.com" target="_blank">Help Center Live</a> {$conf.version}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copyright &copy; <a href="http://www.helpcenterlive.com">Help Center Live</a>. All Rights Reserved.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{$conf.url}/admin/update.php"><i>{$lang.updates}</i></a>
</div>
</body>
</html>