...
<body>
<div id="wrapper">
<div id="header"><img src="{$conf.url}/templates/{$conf.template}/images/logo/main.gif" width="130" height="54" /></div>
<div id="page">
...
<div id="footer">
  {$lang.powered_by} <a href="http://www.helpcenterlive.com" target="_blank">Help Center Live</a> {$conf.version}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copyright &copy; <a href="http://www.helpcenterlive.com">Help Center Live</a>. All Rights Reserved.</a>
</div>
</body>
</html>